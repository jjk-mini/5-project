          ...
          >
            {similar.map((similarRoom) => (
              ...
              >
                ...
                >
                  <img
                    src={similarRoom.image || "/rooms/default-room.jpg"}
                    alt={similarRoom.type || "Hotel room"}
                    style={{
                      width: "100%",
                      height: "100%",
                      objectFit: "cover",
                ...
                >
                  PKR {Number(similarRoom.price || 0).toLocaleString()} / night
                </div>
              </Link>
            ))}
          </div>
